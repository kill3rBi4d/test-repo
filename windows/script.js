...
$(document).ready(function(){
	$(".window").each(function() {      		// window template
		...
		$(this).prepend('<div class="windowHeader"><strong>' + $(this).attr("data-title") + '</strong> <div class="tab-icons"><span title="Minimize" class="winminimize"><i class="fa fa-minus"></i> </span><span title="Maximize" class="winmaximize"><i class="fa fa-expand"></i></i></span><span title="Close" class="winclose"><i class="fa fa-x"></i></span></div></div>');
	});
    ...
    $(".winmaximize").click(function(){
		if ($(this).parent().parent().parent().hasClass('fullSizeWindow')) {			// minimize
